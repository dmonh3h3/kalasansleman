			...
			<footer class="sticky-footer bg-white">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; Kecamatan Sleman <?= date('Y'); ?></span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
			...
			<!-- Sweet Alert -->
			<script src="<?= base_url(''); ?>asset/admin/js/sweetalert2.all.min.js"></script>

			<!-- Script Saya -->
			<script src="<?= base_url(''); ?>asset/admin/js/script_sweetalert.js"></script>
			...
			<script>
				...
				xhr.onreadystatechange = function () {
					if (xhr.readyState == 4 && xhr.status == 200) {
						...
						document.getElementById('exportbtn').href="<?= base_url('files/download/');?>export/siswa/"+x;
				...
				xhr.open('GET', '<?=base_url('siswa/GetSiswaByKelas/')?>'+x, true)
				xhr.send();
			}
			</script>
